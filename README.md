...
1. Для запуска проекта необходимо заполнить файл **.env** с переменными окружения. По адресу *infra/* расположен шаблон заполнения. Важно, чтобы указанный файл находился в одной директории с файлом **docker-compose.yaml**.
